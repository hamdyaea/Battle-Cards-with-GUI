...
Pic2treffles = "./Pictures/2treffles.jpg"
Pic3carreaux = "./Pictures/3Carreaux.jpg"
Pic3coeur = "./Pictures/3Coeur.jpg"
Pic3piques = "./Pictures/3Piques.jpg"
Pic3treffles = "./Pictures/3treffles.jpg"
Pic4carreaux = "./Pictures/4Carreaux.jpg"
Pic4coeur = "./Pictures/4Coeur.jpg"
Pic4piques = "./Pictures/4Piques.jpg"
Pic4treffles = "./Pictures/4treffles.jpg"
Pic5carreaux = "./Pictures/5Carreaux.jpg"
Pic5coeur = "./Pictures/5coeur.jpg"
Pic5piques = "./Pictures/5Piques.jpg"
Pic5treffles = "./Pictures/5treffles.jpg"
Pic6carreaux = "./Pictures/6Carreaux.jpg"
Pic6coeur = "./Pictures/6Coeur.jpg"
Pic6piques = "./Pictures/6Piques.jpg"
Pic6treffles = "./Pictures/6treffles.jpg"
Pic7carreaux = "./Pictures/7Carreaux.jpg"
Pic7coeur = "./Pictures/7Coeur.jpg"
Pic7piques = "./Pictures/7Piques.jpg"
Pic7treffles = "./Pictures/7treffles.jpg"
Pic8carreaux = "./Pictures/8Carreaux.jpg"
Pic8coeur = "./Pictures/8Coeur.jpg"
Pic8piques = "./Pictures/8Piques.jpg"
Pic8treffles = "./Pictures/8treffles.jpg"
Pic9carreaux = "./Pictures/9Carreaux.jpg"
Pic9coeur = "./Pictures/9Coeur.jpg"
Pic9piques = "./Pictures/9Piques.jpg"
Pic9treffles = "./Pictures/9treffles.jpg"
Pic10carreaux = "./Pictures/10Carreaux.jpg"
Pic10coeur = "./Pictures/10Coeur.jpg"
Pic10piques = "./Pictures/10Piques.jpg"
Pic10treffles = "./Pictures/10treffles.jpg"
AsCarreaux = "./Pictures/AsDeCaraux.jpg"
AsCoeur = "./Pictures/AsDeCoeur.jpg"
AsPiques = "./Pictures/AsDePique.jpg"
AsTreffles = "./Pictures/AsDeTreffles.jpg"
ReineCarreaux = "./Pictures/ReineCarreaux.jpg"
ReineCoeur = "./Pictures/ReineCoeur.jpg"
ReinePiques = "./Pictures/ReinePiques.jpg"
ReineTreffles = "./Pictures/ReineTreffles.jpg"
RoiCarreaux = "./Pictures/RoiCarreaux.jpg"
RoiCoeur = "./Pictures/RoiCoeur.jpg"
RoiPiques = "./Pictures/RoiPiques.jpg"
RoiTreffles = "./Pictures/RoiTreffles.jpg"
ValetCarreaux = "./Pictures/ValetCarreaux.jpg"
ValetCoeur = "./Pictures/ValetCoeur.jpg"
ValetPiques = "./Pictures/ValetPiques.jpg"
ValetTreffles = "./Pictures/ValetTreffles.jpg"
image1 = ""
image2 = ""
...
CardList = {
    ...
    "CardAsPiques": 15,
    "CardAsTreffles": 15,
    "CardReineCarreaux": 13,
    "CardReineCoeur": 13,
    "CardReinePiques": 13,
    "CardReineTreffles": 13,
    "CardRoiCarreaux": 14,
    "CardRoiCoeur": 14,
    "CardRoiPiques": 14,
    "CardRoiTreffles": 14,
    "CardValetCarreaux": 12,
    "CardValetCoeur": 12,
    "CardValetPiques": 12,
    "CardValetTreffles": 12,
}
Cards2play = [
    "Card2carreaux",
    "Card2coeur",
...
def GameBattle():
    ...
    if CardList[usrCards[0]] == CardList[cpuCards[0]]:
        Image = image1, image2
        msg = (
            "                              Eguality, we continue the battle\n\n\n              "
            + str("\n\n Your cards : ")
            + str(len(usrCards))
            + str("\n\n\n Computer cards : ")
            + str(len(cpuCards))
        ...
        Image = image1, image2
        msg = (
            "                    You lose the battle, we continue the game\n\n\n              "
            + str("\n\n Your cards : ")
            + str(len(usrCards))
            + str("\n\n\n Computer cards : ")
            + str(len(cpuCards))
        ...
        Image = image1, image2
        msg = (
            "                    You win the battle, we continue the game\n\n\n              "
            + str("\n\n Your cards : ")
            + str(len(usrCards))
            + str("\n\n\n Computer cards : ")
            + str(len(cpuCards))
